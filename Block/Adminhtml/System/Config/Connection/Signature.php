...
class Signature extends \Magento\Config\Block\System\Config\Form\Field
{
    protected function _getElementHtml(\Magento\Framework\Data\Form\Element\AbstractElement $element): string
    {
        ...
        return implode('', [
            ...
            '<button class="action-generate-signature" type="button" onclick="Ogone.generateHash(\''.$id.'\', 40);">',
            ...
            '&nbsp;&nbsp;&nbsp;',
            // info modal link
            '<a href="#" class="modal-link" data-modal-id="connection_signature_content" data-modal-title="'.__('modal.directlink.label7').'">',
            __("form.connection.label.howto").'</a>',
            '</div>',
        ]);
    }
}
